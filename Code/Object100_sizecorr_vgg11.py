...
cnn_net = models.vgg11(pretrained=False)
...
cnn_net.load_state_dict(torch.load('/nfs/a1/userhome/huangtaicheng/workingdir/models/DNNmodel_param/vgg11.pth'))
