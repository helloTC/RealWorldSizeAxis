...
cnn_net = models.resnet18(pretrained=False)
...
cnn_net.load_state_dict(torch.load('/nfs/a1/userhome/huangtaicheng/workingdir/models/DNNmodel_param/resnet18.pth'))
...
layer_loc_all = [('conv1'), ('layer1', '0', 'conv1'), ('layer1', '0', 'conv2'),
                 ('layer1', '1', 'conv1'), ('layer1', '1', 'conv2'),
                 ('layer2', '0', 'conv1'), ('layer2', '0', 'conv2'),
                 ('layer2', '0', 'downsample', '0'), ('layer2', '1', 'conv1'),
                 ('layer2', '1', 'conv2'), ('layer3', '0', 'conv1'),
                 ('layer3', '0', 'conv2'), ('layer3', '0', 'downsample', '0'),
